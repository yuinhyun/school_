...
public class Constants {
	...
	public static final String MYSQL_URL ="jdbc:mysql://hostname:1521/xe";
	public static final String MYSQL_ID ="system";
	public static final String MYSQL_PASSWORD ="oracle";*/
	
	/*public static final String MSSQL_DRIVER ="";
	public static final String MSSQL_URL ="jdbc:"";
